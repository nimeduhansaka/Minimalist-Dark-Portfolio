import { Code2, Palette, Zap, Award, Users, Rocket } from 'lucide-react';
    ...
    return (
        <section id="about" className="min-h-screen flex items-center py-20 relative">
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                <h2 className="text-5xl md:text-8xl font-bold tracking-tighter mb-20">
                    ...
                    <div className="space-y-8">
                        <div className="relative pl-8 border-l-2 border-white/20">
                            ...
                            <p className="text-lg text-gray-400 leading-relaxed">
                                ...
                                I specialize in crafting modern web applications that blend creativity and functionality. 
                        ...
                        <div className="grid grid-cols-3 gap-6 pt-8">
                            {stats.map((stat, index) => (
                                ...
                                >
                                    <stat.icon className="mx-auto mb-3 opacity-50" size={28} />
                            ...
                            <div className="flex flex-wrap gap-3">
                                {technologies.map((tech, index) => (
                                    ...
                                    >
                                        ...
                                        <span className="relative z-10 px-5 py-2.5 text-sm border border-white/30 inline-block group-hover:text-black transition-colors duration-300">
                      {tech}
                    </span>
                                    </div>
                                ))}
                ...
                <div className="grid md:grid-cols-3 gap-6">
                    {skills.map((skill, index) => (
                        ...
                        >
                            <div className="absolute inset-0 bg-white/5 transform origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-500" />
                            <div className="relative p-10 border border-white/10 hover:border-white/30 transition-colors duration-300">
                                <skill.icon
                                    size={48}
                                ...
                                <div className="mt-6 h-[1px] w-0 bg-white group-hover:w-full transition-all duration-500" />
                            </div>
                        </div>
                    ))}
                </div>
